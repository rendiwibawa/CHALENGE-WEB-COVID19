...
<div class="full-menu">
	<div class="fullmenu-content">
		<ul class="page-menu">
			...
			<li><a href="#">About developer</a></li><br>
			<li class="social">
...
<section class="main">
	<div class="main-content">
        <span class="hello">Terima Kasih Telah Melakukan Tes</span><br>
        <h1 class="main-title">Berikut Ini adalah Hasil Kesimpulan Dari Tes Anda
        </h1><br>
        </h1><br>
        <!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahpasien"><i class="fas fa-check"></i> 
HASIL TES !!
</button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tambahpasienTitle"><i class="fas fa-file mr-2"></i>Hasil Tes</h5>
      ...
      <div class="card-body">
                    <form method="post"enctype="multipart/form-data" action="proses-tambah.php">
                        <!-- AWALllllllllllllllllllllllllllllllllllllllll -->

                        <?php 
include '../koneksi.php';
$sql = "SELECT * FROM cek ORDER BY nama";
...
<div class="container">
    <div class="row mt-10">
        <div class="col-md-16">
        <h2 class="card-title"><i class="fas fa-user"></i> Detail Tes</h2>
            <hr class="bg-light">                
                ...
                <tr>
                    <td><strong>Hasil Tes1</strong></td>                    
                    <td><?= $detail['tes1'] ?></td>
                </tr>
                <tr>
                    <td><strong>Hasil Tes2</strong></td>                    
                    <td><?= $detail['tes2'] ?></td>
                </tr>
                <tr>
                    <td><strong>Hasil Tes3</strong></td>                    
                    <td><?= $detail['tes3'] ?></td>
                </tr>
                <tr>
                    <td><strong>Hasil Tes4</strong></td>                    
                    <td><?= $detail['tes4'] ?></td>
                </tr>
                </table> 
        </div>
...
?>
      ...
      <button type="reset" onclick="window.location.href='index.php'"class="btn btn-danger" name="kembali">Kembali</button>
      </div>
    </div>
  </div>
</div>
