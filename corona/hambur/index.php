...
<section class="main">
	<div class="main-content">
        <span class="hello">Hello Selamat Datang</span>
		<h1 class="main-title">Selamat Bertugas Pahlawan<br>
        Tetaplah Semangat Berjuang Menolong Bangsamu <br>
        Engkaulah Pahlawanku.</h1><br>
        <li><a class="btn btn-success" href="http://localhost/corona/login.php">Login Medis</a></li>
		<div class="social">
			<!-- <a href="#"><img src="icons/social/twitter.svg" alt=""></a>
			<a href="#"><img src="icons/social/instagram.svg" alt=""></a>
			<a href="#"><img src="icons/social/dribbble.svg" alt=""></a> -->
